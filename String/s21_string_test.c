...
START_TEST(s21_strtok_test) {
  // Test case 1: basic
  char str1[] = "hello * school21 - how are you ~ today";
  char str2[] = "hello * school21 - how are you ~ today";
  const char *delim1 = "-*~";
  char *expected_result1 = strtok(str1, delim1);
  char *actual_result1 = s21_strtok(str2, delim1);
  ck_assert_pstr_eq(actual_result1, expected_result1);

  expected_result1 = strtok(NULL, delim1);
  actual_result1 = s21_strtok(NULL, delim1);
  ck_assert_pstr_eq(actual_result1, expected_result1);
  ...
  // Test case 2: only delimiter in src string
  char str3[] = "o";
  char str4[] = "o";
  char delim2[] = "school21 delim";
  char *expected_result2 = strtok(str3, delim2);
  char *actual_result2 = s21_strtok(str4, delim2);
  // printf("original: %s\n", expected_result2);
  // printf("     s21: %s\n", actual_result2);
  ck_assert_pstr_eq(expected_result2, actual_result2);

  // Test case 3: multiple delimiter upfront
  char str5[] = "   school21 school22";
  char str6[] = "   school21 school22";
  char delim3[] = " ";
  char *expected_result3 = strtok(str5, delim3);
  char *actual_result3 = s21_strtok(str6, delim3);
  expected_result3 = strtok(NULL, delim3);
  actual_result3 = s21_strtok(NULL, delim3);
  // printf("original: %s\n", expected_result3);
  // printf("     s21: %s\n", actual_result3);
  ck_assert_pstr_eq(expected_result3, actual_result3);

  // Test case 4: empty src
  char str7[] = "";
  char str8[] = "";
  char delim4[] = "";
  char *expected_result4 = strtok(str7, delim4);
  char *actual_result4 = s21_strtok(str8, delim4);
  // printf("original: %s\n", expected_result4);
  // printf("     s21: %s\n", actual_result4);
  ck_assert_pstr_eq(expected_result4, actual_result4);
}
END_TEST
